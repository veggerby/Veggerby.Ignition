# Veggerby.Ignition.Pulsar.Client

Apache Pulsar readiness verification package for Veggerby.Ignition using the [Pulsar.Client](https://github.com/fsharplang-ru/pulsar-client-dotnet) library.
...
```csharp
using Veggerby.Ignition.Pulsar.Client;
