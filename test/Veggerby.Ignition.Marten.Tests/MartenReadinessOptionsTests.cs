...
public class MartenReadinessOptionsTests
{
    [Fact]
    ...
    [Fact]
    public void VerifyDocumentStore_DefaultsToTrue()
    {
        // arrange & act
        var options = new MartenReadinessOptions();

        // assert
        options.VerifyDocumentStore.Should().BeTrue();
    }

    [Fact]
    public void VerifyDocumentStore_CanBeSet()
    {
        // arrange
        var options = new MartenReadinessOptions();

        // act
        options.VerifyDocumentStore = false;

        // assert
        options.VerifyDocumentStore.Should().BeFalse();
    }
